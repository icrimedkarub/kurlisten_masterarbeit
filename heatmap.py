...
# --- Step 0: Load data ---
df = pd.read_excel("/Users/heima/Desktop/Masterarbeit/Kurlisten/Kurlisten_Excel/addresses_with_coords.xlsx")
map_img = Image.open("/Users/heima/Desktop/Masterarbeit/Baden_Karten/baden_1870.png").convert("RGB")
map_img = np.array(map_img)
ref = pd.read_excel("/Users/heima/Desktop/Masterarbeit/Kurlisten/Kurlisten_Excel/ref_points.xlsx")
